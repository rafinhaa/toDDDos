...
type CompleteTaskUseCaseResponse = Either<NotFoundError | NotPermissionError, { task: Task }>;
...
export class CompleteTaskUseCase {
  ...
  async execute({ taskId, userId}: CompleteTaskUseCaseRequest) : Promise<CompleteTaskUseCaseResponse> {
